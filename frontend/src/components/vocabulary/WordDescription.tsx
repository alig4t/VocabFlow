    ...
    return (
      <div className={cn("mt-1.5 space-y-0.5", className)}>
        {eng && (
          <p
            dir="ltr"
            className="line-clamp-1 text-start text-xs leading-snug text-muted-foreground"
          >
            {eng}
          </p>
        )}
        {per && (
          <p
            dir="rtl"
            className="rtl line-clamp-1 text-start text-xs leading-snug text-muted-foreground/80"
          >
            {per}
          </p>
        )}
  ...
  return (
    ...
    >
      <div className="border-b border-primary/10 bg-primary/5 px-3 py-1">
        <span className="font-persian text-[10px] font-semibold tracking-wide text-primary/80">
          تعریف
        </span>
      </div>
      <div className="space-y-1 px-3 py-2.5">
        {eng && (
          <p
            dir="ltr"
            className="text-start text-sm leading-relaxed text-foreground/90"
          >
            {eng}
          </p>
        )}
        {per && (
          <p
            dir="rtl"
            className="rtl text-start text-xs leading-relaxed text-muted-foreground"
          >
            {per}
          </p>
        )}
