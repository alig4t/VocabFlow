  ...
  return (
    ...
    >
      ...
      <g className="fill-violet">
        <text x="96" y="30" fontSize="19" fontWeight="900" opacity="0.75">
          A
        </text>
        <text x="126" y="18" fontSize="13" fontWeight="900" opacity="0.45">
          C
        </text>
      </g>
      <text
      ...
      <g className="fill-primary">
        ...
        <path
          d="M168 12l1.8 4.6 4.6 1.8-4.6 1.8-1.8 4.6-1.8-4.6-4.6-1.8 4.6-1.8z"
          opacity="0.8"
        />
      </g>
