...
export function LoginPage() {
    ...
    login.mutate(data, {
      ...
      onError: (error) => {
        toast({
          title: "ورود ناموفق",
          description:
            error.message ?? "ایمیل یا رمز عبور اشتباه است. دوباره تلاش کنید.",
          variant: "destructive",
        });
      },
    });
  ...
  return (
    <div
      dir="rtl"
      className="font-persian min-h-screen bg-gradient-to-bl from-background via-background to-muted/30 flex items-center justify-center p-4"
    >
