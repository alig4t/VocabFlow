...
const cx = {
  ...
  card: "rounded-2xl border border-slate-200/80 bg-white/80 shadow-sm transition-all duration-300 dark:border-white/[0.07] dark:bg-white/[0.025] dark:shadow-none",
  chipAmber:
...
const DIVIDER_WAVES = {
  b: {
    h: 90,
    d: "M0,45 C320,95 560,12 760,46 C1000,86 1200,22 1440,54 L1440,90 L0,90 Z",
  },
  c: { h: 90, d: "M0,58 C480,-8 960,104 1440,42 L1440,90 L0,90 Z" },
  d: {
    h: 90,
    d: "M0,42 C240,88 480,88 720,50 C960,14 1200,14 1440,50 L1440,90 L0,90 Z",
  },
...
function useFloatingWords(count: number): WordConfig[] {
  return useMemo(() => {
    return Array.from({ length: count }, (_, i) => {
      ...
      else if (inUpperBand) maxOpacity = 0.3 + pseudo(i * 11) * 0.32;
      else maxOpacity = 0.14 + pseudo(i * 11) * 0.2;
...
const HERO_BOOKS = [
  {
    src: "/books/Essentaial-words-for-the-ielts.png",
    rotate: -27,
    left: 4,
    w: 104,
    z: 2,
  ...
  {
    src: "/books/oxford-word-skills-advanced.webp",
    rotate: -18,
    left: 52,
    w: 116,
    z: 3,
  ...
  {
    src: "/books/english-phrasal-verbs-in-use.png",
    rotate: 4,
    left: 224,
    w: 152,
    z: 10,
  ...
  {
    src: "/books/oxford-word-skills-basic.webp",
    rotate: 20,
    left: 342,
    w: 120,
    z: 3,
...
const LIBRARY = [
  ...
  {
    src: "/books/oxford-word-skills-basic.webp",
    label: "Oxford Word Skills · Basic",
  },
  {
    src: "/books/oxford-word-skills-intermediate.webp",
    label: "Oxford Word Skills · Intermediate",
  },
  {
    src: "/books/oxford-word-skills-advanced.webp",
    label: "Oxford Word Skills · Advanced",
  },
  {
    src: "/books/english-phrasal-verbs-in-use.png",
    label: "English Phrasal Verbs in Use",
  },
  { src: "/books/1000-collocation.png", label: "1000 English Collocations" },
  {
    src: "/books/Essentaial-words-for-the-ielts.png",
    label: "Essential Words · IELTS",
  },
  {
    src: "/books/Essentaial-words-for-the-toefl.png",
    label: "Essential Words · TOEFL",
  },
  {
    src: "/books/Essentaial-words-for-the-GRE-1.png",
    label: "Essential Words · GRE",
  },
...
const FEATURES = [
  ...
  },
  {
    icon: Target,
    title: "فیلتر هوشمند",
    desc: "فقط واژه‌هایی که هنوز یاد نگرفته‌اید را با تمرکز بیشتر مرور کنید.",
  },
  {
    icon: BarChart3,
  ...
  },
  {
    ...
    desc: "برای هر واژه، هم‌معنی‌ها و متضادها را ببینید و دایره واژگان را گسترش دهید.",
  },
  {
    icon: BookOpen,
    title: "مثال‌های واقعی",
    desc: "هر واژه، عبارت و باهم‌آیی با جمله مثال انگلیسی و ترجمه فارسی همراه است.",
  },
  {
    icon: CalendarCheck,
    title: "نقشه فعالیت",
  ...
  },
  {
    ...
    desc: "صف مرور هوشمند، واژگان را دقیقاً زمانی که در آستانه فراموشی هستند برمی‌گرداند.",
  },
  {
    icon: Users,
    title: "حساب مستقل",
...
const STEPS = [
  ...
  },
  {
    ...
    desc: "از میان واژه‌ها، افعال عبارتی و باهم‌آیی‌ها، مسیر خود را بچینید.",
  },
  {
    num: "۳",
...
const TESTIMONIALS = [
  {
    ...
    avatar: "ن",
    text: "بهترین روش برای یادگیری واژه‌های تخصصی. با این پلتفرم ظرف سه ماه واژگانم دو برابر شد.",
  },
  {
    name: "رضا مرادی",
    role: "مترجم حرفه‌ای",
...
function StatPill({ value, label }: { value: string; label: string }) {
  return (
    <div className="flex flex-col items-end gap-0.5">
      ...
      <span className="text-[11px] leading-none text-slate-500 dark:text-white/45">
        {label}
      </span>
    </div>
  );
...
function CoverCard({ src, label }: { src: string; label: string }) {
  return (
    <div className="group relative w-[132px] shrink-0 sm:w-[150px]">
      ...
      <p
        className="mt-2.5 line-clamp-1 text-center text-[11px] text-slate-500 dark:text-white/40"
        title={label}
      >
        {label}
      </p>
...
export default function LandingPage() {
  ...
  return (
    <div
      dir="rtl"
      className={`min-h-screen overflow-x-hidden font-persian text-slate-900 dark:text-white ${cx.page}`}
    >
      {/* ════════════════════════════════ NAVBAR ════════════════════════════════ */}
      <nav className="fixed inset-x-0 top-0 z-50 flex h-16 items-center justify-between border-b border-slate-200/70 bg-[#faf7f1]/80 px-5 backdrop-blur-xl dark:border-white/[0.07] dark:bg-[#0a0f1a]/70 sm:px-8">
        <Link to="/" className="flex items-center gap-2.5">
          ...
          <div className="leading-none">
            ...
            <span className="block text-[10px] text-amber-600 dark:text-amber-300/70">
              VocabFlow
            </span>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-2.5">
          ...
          {isAuthenticated ? (
            ...
            <>
              <Link
                to="/login"
                className="hidden px-3 py-1.5 text-[13px] text-slate-500 transition-colors hover:text-slate-900 dark:text-white/55 dark:hover:text-white sm:block"
              >
                ورود
              </Link>
              <Link
      ...
      <section className="relative flex min-h-screen items-center overflow-hidden">
        ...
        <div
          className="orb absolute bottom-[18%] left-[18%] h-[380px] w-[380px] rounded-full bg-sky-400/15 blur-[90px] dark:bg-sky-500/10"
          style={{ animationDelay: "2s" }}
        />
        <div
          className="orb absolute left-[52%] top-[48%] h-[300px] w-[300px] rounded-full bg-amber-300/20 blur-[70px] dark:bg-amber-400/8"
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle, #e4a824 1px, transparent 1px)",
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col-reverse items-center gap-14 px-6 pb-20 pt-28 sm:px-10 lg:flex-row-reverse lg:gap-10">
          ...
          <div className="flex min-w-0 flex-1 items-end justify-center pb-4 lg:pb-0">
            ...
            >
              ...
              <div
                className="absolute z-20 rounded-full border border-amber-400/30 bg-amber-500/90 px-3 py-1.5 text-[11px] font-bold text-[#1a1206] shadow-xl backdrop-blur-md"
                style={{ top: "6%", right: "4%" }}
              >
                ۱۳+ کتاب مرجع
              </div>
              <div
                className="absolute z-20 rounded-full border border-slate-300/60 bg-white/70 px-2.5 py-1 text-[11px] text-slate-700 backdrop-blur-md dark:border-white/15 dark:bg-white/10 dark:text-white/85"
          ...
          <div className="min-w-0 flex-1 text-right">
            ...
            <p className="mb-9 max-w-md text-[1.05rem] leading-[1.9] text-slate-600 dark:text-white/55">
              واژه‌ها، افعال عبارتی و باهم‌آیی‌ها را با فلش‌کارت دوطرفه،
              مثال‌های واقعی و داشبورد پیشرفت شخصی مرور کنید — همه در یک پلتفرم
              فارسی.
            </p>
              ...
              <div className="flex items-center gap-2">
                <div className="flex -space-x-2.5 rtl:space-x-reverse">
                  {[
                    ...
                    <div
                      key={i}
                      className={`h-7 w-7 rounded-full bg-gradient-to-br ${g} border-2 border-[#faf7f1] dark:border-[#101a30]`}
                    />
                  ))}
                </div>
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-0">
          ...
          >
            <path
              ...
              className="fill-[#faf7f1] dark:fill-[#0a0f1a]"
            />
          </svg>
        </div>
      </section>
      ...
      {/* ════════════════════════════════ TRUST BAR ═════════════════════════════ */}
      <div
        className={`border-y border-slate-200 dark:border-white/[0.05] ${cx.page} py-10`}
      >
        <div className="mx-auto max-w-4xl px-6">
          <p className="mb-6 text-center text-xs uppercase tracking-widest text-slate-400 dark:text-white/30">
            یک کتابخانه کامل در جیب شما
          </p>
          <div className="grid grid-cols-2 gap-6 text-center sm:grid-cols-4">
            {[
              ...
              <div key={l} className="flex flex-col items-center gap-1">
                <span className="bg-gradient-to-l from-amber-600 to-yellow-600 bg-clip-text text-2xl font-bold text-transparent dark:from-amber-300 dark:to-yellow-500">
                  {n}
                </span>
      ...
      <section id="pillars" className={`${cx.page} py-28`}>
        <div className="mx-auto max-w-6xl px-6 sm:px-10">
          <div className="mb-16 text-center">
            <p
              className={`mb-3 text-xs font-semibold uppercase tracking-widest ${cx.eyebrow}`}
            >
              سه مسیر، یک هدف
            </p>
            <h2 className={`mb-4 text-3xl font-bold sm:text-4xl ${cx.heading}`}>
              فراتر از حفظ کردن واژه
            </h2>
            <p
              className={`mx-auto max-w-xl text-sm leading-relaxed ${cx.mutedSoft}`}
            >
              زبان طبیعی فقط واژه نیست. وکب فلو سه لایه کلیدی زبان را به شما
              می‌آموزد تا انگلیسی شما روان و واقعی شود.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
            {PILLARS.map((p, i) => (
              <div
                key={i}
                className={`group relative overflow-hidden p-7 text-right ring-1 ring-inset ${p.ring} ${cx.card} hover:-translate-y-1.5 hover:bg-white dark:hover:bg-white/[0.05]`}
              >
                <div
                  className={`absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent to-transparent ${cx.hair}`}
                />
                <div
                  className={`pointer-events-none absolute -bottom-16 -left-16 h-40 w-40 rounded-full bg-gradient-to-tr ${p.glow} to-transparent opacity-0 blur-2xl transition-opacity duration-500 group-hover:opacity-100`}
                />

                <div className="mb-5 flex items-center justify-between">
                  <span
                    className={`inline-flex items-center gap-1.5 rounded-lg border px-2.5 py-1 text-[11px] font-semibold ${p.chip}`}
                  >
                    {p.en}
                  </span>
                ...
                <h3 className={`mb-1 text-lg font-bold ${cx.heading}`}>
                  {p.tag}
                </h3>
                <p className={`mb-5 text-sm leading-relaxed ${cx.muted}`}>
                  {p.desc}
                </p>

                <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-center dark:border-white/10 dark:bg-black/20">
                  <div
                    className={`mb-1 font-mono text-lg font-bold ${cx.heading}`}
                    dir="ltr"
                  >
                    {p.sample.eng}
                  </div>
      ...
      <section id="library" className="relative overflow-hidden py-28">
        ...
        <div className="relative z-10">
          <div className="mx-auto mb-14 max-w-6xl px-6 text-center sm:px-10">
            ...
            <p
              className={`mx-auto max-w-lg text-sm leading-relaxed ${cx.mutedSoft}`}
            >
              از ۴۰۰۰ واژه ضروری و Oxford Word Skills تا افعال عبارتی،
              باهم‌آیی‌ها و واژگان تخصصی آزمون‌ها — همه به‌صورت فلش‌کارت آماده
              مرور.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-6xl px-6 sm:px-10">
          <div className="mb-16 text-center">
            ...
            <p
              className={`mx-auto max-w-lg text-sm leading-relaxed ${cx.mutedSoft}`}
            >
              ابزارهایی که یادگیری واژگان را از یک کار خسته‌کننده به عادتی
              روزانه و لذت‌بخش تبدیل می‌کند.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {FEATURES.map((f, i) => (
              <div
                key={i}
                className={`group relative overflow-hidden p-6 text-right ${cx.card} hover:-translate-y-1.5 hover:bg-white dark:hover:bg-white/[0.05]`}
              >
                <div
                  className={`absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent to-transparent ${cx.hair}`}
                />
                ...
                <h3 className={`mb-2 text-base font-semibold ${cx.heading}`}>
                  {f.title}
                </h3>
                <p className={`text-sm leading-relaxed ${cx.mutedSoft}`}>
                  {f.desc}
                </p>
              </div>
            ))}
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-6 sm:px-10">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="text-right">
              ...
              <h2
                className={`mb-5 text-3xl font-bold sm:text-4xl ${cx.heading}`}
              >
                پیشرفتت را می‌بینی، پس ادامه می‌دهی
              </h2>
              <p className={`mb-8 text-sm leading-relaxed ${cx.muted}`}>
                هر کتاب نوار پیشرفت مخصوص خودش را دارد. رشته یادگیری، آمار
                روزانه، واژگان آماده مرور و درصد تسلط — همه در یک نگاه.
              </p>
              <ul className="space-y-3.5">
                {[
                  [
                    "نوار پیشرفت هر کتاب",
                    "درصد واژگان یادگرفته‌شده را زنده دنبال کنید.",
                  ],
                  [
                    "صف مرور هوشمند",
                    "دقیقاً بدانید امروز کدام واژگان را باید مرور کنید.",
                  ],
                  [
                    "نقشه فعالیت و رشته",
                    "انگیزه‌تان را با حفظ رشته روزهای مطالعه بالا نگه دارید.",
                  ],
                ].map(([t, d]) => (
                  <li key={t} className="flex items-start gap-3 text-right">
                    ...
                    <div>
                      <p className={`text-sm font-semibold ${cx.heading}`}>
                        {t}
                      </p>
              ...
              <div className="relative rounded-2xl border border-slate-200 bg-white/90 p-5 shadow-2xl shadow-slate-900/10 backdrop-blur-sm dark:border-white/10 dark:bg-[#0e1626]/90 dark:shadow-black/40">
                <div className="mb-4 grid grid-cols-3 gap-3">
                  {[
                    ...
                    <div
                      key={i}
                      className="rounded-xl bg-slate-50 p-3 text-center ring-1 ring-inset ring-slate-200/70 dark:bg-white/[0.045] dark:ring-white/[0.04]"
                    >
                      <s.icon
                        size={16}
                        className="mx-auto mb-1.5 text-amber-500 dark:text-amber-300"
                      />
                      <div className={`text-lg font-bold ${cx.heading}`}>
                        {s.v}
                      </div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div
                      key={b.title}
                      className="rounded-xl bg-slate-50 p-3.5 ring-1 ring-inset ring-slate-200/70 dark:bg-white/[0.045] dark:ring-white/[0.04]"
                    >
                      <div className="mb-2 flex items-center justify-between">
                        ...
                        <span
                          className={`text-[13px] font-medium ${cx.heading}`}
                          dir="ltr"
                        >
                          {b.title}
                        </span>
                      ...
                      <div className="h-2 overflow-hidden rounded-full bg-slate-200 dark:bg-white/10">
                        <div
                          className={`h-full rounded-full bg-gradient-to-l ${b.tint}`}
                          style={{ width: `${b.pct}%` }}
                        />
                      </div>
                    </div>
                ...
                <div className="mt-4 rounded-xl bg-slate-50 p-3.5 ring-1 ring-inset ring-slate-200/70 dark:bg-white/[0.045] dark:ring-white/[0.04]">
                  <div className="mb-2 text-right text-[11px] text-slate-500 dark:text-white/40">
                    فعالیت ۵ هفته اخیر
                  </div>
                  <div className="flex flex-wrap justify-end gap-1">
                    {[...Array(35)].map((_, i) => {
                      ...
                      return (
                        <div
                          key={i}
                          className={`h-3 w-3 rounded-[3px] ${shades[lvl]}`}
                        />
                      );
                    })}
                  </div>
      ...
      <section className={`${cx.page} py-24`}>
        <div className="mx-auto max-w-5xl px-6 sm:px-10">
          <div className="mb-12 text-center">
            ...
            <h2 className={`mb-3 text-3xl font-bold ${cx.heading}`}>
              دو جهت یادگیری، در یک فلش‌کارت
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="group relative overflow-hidden rounded-2xl border border-amber-300/60 bg-gradient-to-br from-amber-100 to-amber-50/40 p-7 text-right transition-colors hover:border-amber-400 dark:border-amber-400/20 dark:from-amber-500/10 dark:to-amber-500/[0.02] dark:hover:border-amber-400/40">
              ...
              <h3 className={`mb-2 text-xl font-bold ${cx.heading}`}>
                انگلیسی به فارسی
              </h3>
              <p className={`mb-5 text-sm leading-relaxed ${cx.muted}`}>
                کلمه انگلیسی نشان داده می‌شود؛ معنی فارسی را حدس بزنید، سپس
                نمایان کنید.
              </p>
              <div className="rounded-xl border border-slate-200 bg-white p-4 text-center dark:border-white/10 dark:bg-black/20">
                <div
                  className={`mb-1 font-mono text-2xl font-bold ${cx.heading}`}
                >
                  Afraid
                </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-sky-300/60 bg-gradient-to-br from-sky-100 to-sky-50/40 p-7 text-right transition-colors hover:border-sky-400 dark:border-sky-400/20 dark:from-sky-500/10 dark:to-sky-500/[0.02] dark:hover:border-sky-400/40">
              ...
              <p className={`mb-5 text-sm leading-relaxed ${cx.muted}`}>
                معنی فارسی نشان داده می‌شود؛ کلمه انگلیسی معادل را به خاطر
                بیاورید.
              </p>
              <div className="rounded-xl border border-slate-200 bg-white p-4 text-center dark:border-white/10 dark:bg-black/20">
                <div className={`mb-1 text-2xl font-bold ${cx.heading}`}>
                  ترسیده
                </div>
                <div className="text-sm text-slate-400 dark:text-white/25">
                  ··· کلمه انگلیسی چیست؟ ···
          ...
          <div className="relative grid grid-cols-1 gap-10 md:grid-cols-3">
            ...
            {STEPS.map((s, i) => (
              ...
              >
                ...
                <h3 className={`text-base font-semibold ${cx.heading}`}>
                  {s.title}
                </h3>
                <p
                  className={`mx-auto max-w-[220px] text-sm leading-relaxed ${cx.mutedSoft}`}
                >
                  {s.desc}
                </p>
              </div>
      ...
      <section
        id="testimonials"
        className={`relative overflow-hidden ${cx.page} py-28`}
      >
        <div className="relative z-10 mx-auto max-w-5xl px-6 sm:px-10">
          <div className="mb-16 text-center">
            <p
            ...
            <h2 className={`mb-4 text-3xl font-bold sm:text-4xl ${cx.heading}`}>
              یادگیرندگان درباره وکب فلو چه می‌گویند؟
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
            {TESTIMONIALS.map((t, i) => (
              <div
                key={i}
                className={`group relative p-6 text-right ${cx.card} hover:bg-white dark:hover:border-white/[0.13]`}
              >
                <div
                  className={`absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent to-transparent ${cx.hair}`}
                />
                ...
                <p className={`mb-6 text-[13.5px] leading-[1.85] ${cx.muted}`}>
                  «{t.text}»
                </p>
                <div className="flex flex-row-reverse items-center gap-3">
                  ...
                  <div className="text-right">
                    <div
                      className={`text-sm font-semibold leading-tight ${cx.heading}`}
                    >
                      {t.name}
                    </div>
                    <div className="mt-0.5 text-[11px] text-slate-500 dark:text-white/35">
                      {t.role}
                    </div>
                  </div>
                </div>
      ...
      <section className="relative overflow-hidden py-28">
        ...
        <div className="relative z-10 mx-auto max-w-2xl px-6 text-center">
          ...
          <h2 className={`mb-5 text-3xl font-bold sm:text-4xl ${cx.heading}`}>
            آماده‌ای انگلیسی‌ات را زیر و رو کنی؟
          </h2>
          <p className={`mb-10 text-base leading-relaxed ${cx.muted}`}>
            همین حالا ثبت‌نام کن، کتاب‌هایت را انتخاب کن و پیشرفتت را روز به روز
            تماشا کن — کاملاً رایگان.
          </p>
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-5">
            {[
              ...
              <div
                key={chip}
                className="flex items-center gap-1.5 text-xs text-slate-500 dark:text-white/35"
              >
                <Check
                  size={12}
      ...
      {/* ════════════════════════════════ FOOTER ════════════════════════════════ */}
      <footer
        className={`border-t border-slate-200 dark:border-white/[0.06] ${cx.page} py-10`}
      >
        <div className="mx-auto max-w-6xl px-6 sm:px-10">
          <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
            <div className="flex items-center gap-2.5">
              <LogoMark size={32} />
              <div className="leading-none">
                <span className="block text-sm font-bold text-slate-700 dark:text-white/80">
                  وکب فلو
                </span>
                <span className="block text-[10px] text-slate-500 dark:text-white/35">
                  پلتفرم یادگیری واژگان انگلیسی
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6 text-xs text-slate-400 dark:text-white/25">
              <a
                href="#pillars"
                className="transition-colors hover:text-slate-700 dark:hover:text-white/60"
              >
                مسیرها
              </a>
              <a
