...
export const bookService = {
  ...
  getBooksSimple(): Promise<BookSimple[]> {
    ...
    return api
      .get<BookSimple[]>(API_ENDPOINTS.books.simple)
      .then((r) => r.data);
  },
  ...
  updateBook(id: string, data: Partial<CreateBookData>): Promise<Book> {
    return api
      .put<Book>(API_ENDPOINTS.books.detail(id), data)
      .then((r) => r.data);
  },
  ...
  getVolumes(bookId: string): Promise<Volume[]> {
    ...
    return api
      .get<Volume[]>(API_ENDPOINTS.books.volumes(bookId))
      .then((r) => r.data);
  },
  ...
  getVolumesSimple(bookId: string): Promise<VolumeSimple[]> {
    ...
    return api
      .get<VolumeSimple[]>(API_ENDPOINTS.books.volumesSimple(bookId))
      .then((r) => r.data);
  },

  createVolume(bookId: string, data: CreateVolumeData): Promise<Volume> {
    return api
      .post<Volume>(API_ENDPOINTS.books.volumes(bookId), data)
      .then((r) => r.data);
  },
  ...
  deleteVolume(bookId: string, volumeId: string): Promise<void> {
    return api
      .delete(API_ENDPOINTS.books.volume(bookId, volumeId))
      .then((r) => r.data);
  },
  ...
  getLessons(bookId: string, volumeId: string): Promise<Lesson[]> {
    return api
      .get<Lesson[]>(API_ENDPOINTS.books.lessons(bookId, volumeId))
      .then((r) => r.data);
  },
