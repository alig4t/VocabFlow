...
export type BookLevel =
  "مبتدی" | "متوسط" | "پیشرفته" | "مبتدی تا پیشرفته" | "متوسط تا پیشرفته";
...
> = {
  words: {
    title: "واژه‌ها و واژگان",
    subtitle:
      "گسترش دامنه‌ی واژگان؛ از واژه‌های پایه‌ی روزمره تا سطح آکادمیک و آزمون.",
  },
  collocations: {
...
export const BOOK_META: Record<string, BookMeta> = {
  "504 Absolutely Essential Words": {
    ...
    level: "متوسط",
    about:
      "۵۰۴ واژه‌ی پرکاربرد و ضروری زبان انگلیسی که در درس‌های کوتاه و همراه با مثال ارائه شده‌اند. یک انتخاب کلاسیک برای ساختن پایه‌ای محکم از واژگان روزمره.",
  },
  ...
  "Oxford Word Skills": {
    ...
    level: "مبتدی تا پیشرفته",
    about:
      "یادگیری واژه بر پایه‌ی موضوع، در سه سطح مبتدی، متوسط و پیشرفته. هر بخش واژگان را در بافتِ کاربردی و همراه با تمرین آموزش می‌دهد.",
  },
  "Barron's Essential Words for the GRE": {
    ...
    level: "پیشرفته",
    about:
      "واژگان آکادمیک و سطح‌بالا برای آمادگی آزمون GRE. مناسب کسانی که به‌دنبال تسلط جدی بر واژه‌های دشوار و رسمی هستند.",
  },
  "Barron's Essential Words for the IELTS": {
    ...
    about:
      "واژگان کلیدی و پرتکرار آزمون آیلتس، دسته‌بندی‌شده بر پایه‌ی موضوع‌های رایج این آزمون. همراهی مطمئن برای آمادگی هدفمند.",
  },
  "Barron's Essential Words for the TOEFL": {
    ...
    level: "متوسط تا پیشرفته",
    about:
      "واژگان ضروری آزمون تافل با تمرکز بر انگلیسی آکادمیک. برای تقویت دقیقِ دایره‌ی واژه‌ها پیش از آزمون.",
  },
